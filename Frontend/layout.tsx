...
import { AgentChatbot } from '@/components/ai/AgentChatbot'
...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {/* Persistent floating AI chatbot — always visible across all pages */}
      <AgentChatbot />
    </>
  )
}
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  // Force light mode on load to show a crisp white background
                  const theme = 'light';
